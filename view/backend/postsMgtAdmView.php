    ...
    <section class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <p><a class="btn btn-customBis navbar-btn " href="index.php?action=addFormPost"><strong><span class="glyphicon glyphicon-pencil big"></span>Ajouter un chapitre</strong></a></p>
